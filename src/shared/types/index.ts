...
export type { NftInstagram } from "./contracts/NftInstagram";
export { NftInstagram__factory } from "./factories/contracts/NftInstagram__factory";
export type { NftMinter } from "./contracts/NftMinter";
export { NftMinter__factory } from "./factories/contracts/NftMinter__factory";
